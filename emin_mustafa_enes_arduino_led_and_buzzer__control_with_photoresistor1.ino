...
void loop()
{
  ...
  Serial.println(ldr2_deger);
   ...
   if(tiltVal == HIGH){
     Serial.println("State1 entered");
     

      if (ldr1_deger <300){
        Serial.println("10 led on");
